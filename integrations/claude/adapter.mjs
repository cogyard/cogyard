// integrations/claude/adapter.mjs — the Claude Code integration (task 038).
//
...
// for Claude Code with behaviour byte-identical to the pre-task-038 hardcoded
// engine — moving the Claude-specific logic here is a no-regression refactor.
//
// Seams (see docs/INTEGRATIONS.md for the contract):
