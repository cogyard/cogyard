...
4. **Write the task doc** at `_tasks/NNN-<slug>.md` using the Tier A/B/C template below.
...
1. **Update the TodoWrite list** — mark previous phase completed, current phase in_progress.
...
## Pitfalls — things that went wrong in the canonical run
